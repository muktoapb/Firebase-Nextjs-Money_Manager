  ...
  return (
    <nav className='w-full'>
      <ul className='text-lg text-slate-600 font-medium md:block flex w-full justify-between'>
        ...
        <li className={router.pathname=='/' ? 'navitem_design border-2 border-sky-500': 'hover:navitem_design border-2 border-transparent hover:border-sky-500'}>
          <Link href='/'> 
           <a className='navitem_defult'><MdOutlineDashboard className='md:mr-1'/> <span className="hidden md:block">Dashboard</span></a>
          </Link>
        </li>

        <li className={router.pathname=='/earning' ? 'navitem_design border-2 border-sky-500': 'hover:navitem_design border-2 border-transparent hover:border-sky-500'}>
        ...
        <li className={router.pathname=='/donate' ? 'navitem_design border-2 border-sky-500': 'hover:navitem_design border-2 border-transparent hover:border-sky-500'}>
        ...
        <li className={router.pathname=='/investment' ? 'navitem_design border-2 border-sky-500': 'hover:navitem_design border-2 border-transparent hover:border-sky-500'}>
        ...
        <li className={router.pathname=='/expense' ? 'navitem_design border-2 border-sky-500': 'hover:navitem_design border-2 border-transparent hover:border-sky-500'}>
        ...
        <li className={router.pathname=='/about' ? 'navitem_design border-2 border-sky-500': 'hover:navitem_design border-2 border-transparent hover:border-sky-500'}>
